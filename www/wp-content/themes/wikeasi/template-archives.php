...
//global $query_string;
query_posts('post_type[]=conditions&post_type[]=symptoms&post_type[]=treatments');

//clear out the session cache
$_SESSION['condition_ids'] = array();
$_SESSION['symptom_ids'] = array();
$_SESSION['treatment_ids'] = array();
