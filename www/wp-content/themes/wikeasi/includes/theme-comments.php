	      	...
	      	<div id="li-comment-<?php comment_ID() ?>" class="comment-container">
	            ...
	            <?php } ?>            
		      	...
		      	<div class="comment-head">
	                ...
	                <span class="perma"><a href="<?php echo get_comment_link(); ?>" title="<?php esc_attr_e( 'Direct link to this review', 'woothemes' ); ?>">#</a></span>
				...
				<?php if ( $comment->comment_approved == '0' ) { ?>
	                <p class='unapproved'><?php _e( 'Your review is awaiting moderation.', 'woothemes' ); ?></p>
	            <?php } ?>
