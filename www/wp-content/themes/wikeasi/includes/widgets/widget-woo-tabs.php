...
<div id="tabs">
    ...
    <?php if ( $order == "latest" && !$latest == "on") { ?>
    	<li class="latest"><a href="#tab-latest"><?php _e( 'Recent News', 'woothemes' ); ?></a></li>
    <?php } elseif ( $order == "comments" && !$comments == "on") { ?>
    	<li class="comments"><a href="#tab-comm"><?php _e( 'Most Discussed', 'woothemes' ); ?></a></li>
    ...
    //Trending Topics
    if (!$pop == "on") { ?>
    	<li class="popular"><a href="#tab-pop"><?php _e( 'Most Discussed', 'woothemes' ); ?></a></li><?php } ?>
    <?php if ($order <> "latest" && !$latest == "on") { ?>
    	<li class="latest"><a href="#tab-latest"><?php _e( 'Recent News', 'woothemes' ); ?></a></li><?php } ?>
    <?php if ($order <> "comments" && !$comments == "on") { ?>
    	<li class="comments"><a href="#tab-comm"><?php _e( 'Most Discussed', 'woothemes' ); ?></a></li><?php } ?>
